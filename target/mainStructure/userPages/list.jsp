...
<div class="toper navbar-fixed-top">
    <div class="row color_white " >
        <div class="col-xs-2" style="padding-left:25px;"><a class="cwhite" href="/user/index.action"><i class="icon-angle-left font32"></i></a></div>
        <div class="col-xs-8 text-center font20" style="padding-top: 2px"> <s:property value="category.name"/></div>
...
<div id="loading-area" hidden style="width: 100%;height: 20px;text-align: center">
    <div class="load8">
...
<script type="text/javascript">
    var category = <s:property value="category.id"/>
    ...
    $(window).scroll(function() {
        ...
        if ($(this).scrollTop() + $(window).height() + 100 >= $(document).height() && $(this).scrollTop()> 100) {
            if(stop==true){
                $("#loading-area").show();
                stop = false;
                $.post("/user/categoryProducts.action",{"id":category,"page":p},function (data) {
                    p++;
                    console.log(data);
                    if(data==""){
                        visable = true;
