...
function show_err_msg(msg){
	 ...
	 var errhtml='<div  class="bac" style="padding:8px 0px;width:100%;margin:0 auto;color:#5bc0de;text-align:center;font-size:28px;font-family:微软雅黑;"><img style="margin-right:10px;" src="/asset/sellerAsset/images/error.png">';
	 var errhtmlfoot='</div>';	 
...
function show_msg(msg,url){	
	 ...
	 clearTimeout(msgdsq);
	 $('body').append('<div class="sub_err" style="position:absolute;top:60px;left:0;width:500px;z-index:999999;"></div>');
	 var htmltop='<div class="bac" style="padding:8px 0px;border:1px solid #090;width:100%;margin:0 auto;background-color:#FFF2F8;color:#090;border:3px #090 solid;;text-align:center;font-size:16px;"><img style="margin-right:10px;" src="/asset/sellerAsset/images/loading.gif">';
	 var htmlfoot='</div>';
	 $('.msg_bg').height($(document).height());
	 var left=($(document).width()-500)/2;
	 $('.sub_err').css({'left':left+'px'});
...
function show_loading()
{
	...
	str+='<div class="msg_bg" style="z-index:99999;width:100%;position:absolute;left:0;top:0;text-align:center;"><img src="/asset/sellerAsset/images/loading.gif" alt="" class="loading"></div>'
	$('body').append(str);
	var scroll_height=$(document).scrollTop(); 
	$('.msg_bg').height($(document).height());
